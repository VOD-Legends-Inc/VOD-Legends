...
import "./ReviewedVODSTable.css";

const ReviewedVODSTable = () => (
	<div id="reviewedVODSTable">
		<div id="tableHeaders">
			<div className="tableHeader vodTitle">Title</div>
			<div className="tableHeader coach">Student</div>
		...
		<div id="tableRow">
			...
			<div className="rowOne coach">Azianpinoy</div>
		...
		<div id="tableRow">
			...
			<div className="rowTwo coach">Azianpinoy</div>
		...
		<div id="tableRow">
			...
			<div className="rowThree coach">Azianpinoy</div>
		...
		<div id="tableRow">
			...
			<div className="rowFour coach">Azianpinoy</div>
		...
		<div id="tableRow">
			...
			<div className="rowFive coach">Azianpinoy</div>
...
export default ReviewedVODSTable;
